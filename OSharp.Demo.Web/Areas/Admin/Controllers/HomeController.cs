        ...
        public ActionResult GetMenuData()
        {
            List<TreeNode> nodes = new List<TreeNode>()
            {
                  ...
                  new TreeNode()
                {
                    ...
                    Children = new List<TreeNode>()
                    {
                        new TreeNode() { Text = "游戏管理", IconCls = "pic_37", Url = Url.Action("OperateLogs", "Logging") },
                        new TreeNode() { Text = "内存地址管理", IconCls = "pic_38", Url = Url.Action("SystemLogs", "Logging") },
                        new TreeNode() { Text = "游戏地图管理", IconCls = "pic_39", Url = Url.Action("SystemLogs", "Logging") },
                        new TreeNode() { Text = "游戏坐标管理", IconCls = "pic_40", Url = Url.Action("SystemLogs", "Logging") },
                        new TreeNode() { Text = "游戏大区管理", IconCls = "pic_41", Url = Url.Action("SystemLogs", "Logging") },
                        new TreeNode() { Text = "游戏区服管理", IconCls = "pic_42", Url = Url.Action("SystemLogs", "Logging") }
                    }
                },
                  new TreeNode()
                {
